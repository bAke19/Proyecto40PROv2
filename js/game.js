                ...
                player.getPlayerAtEnd();
                 ...
                 for(var plr in allPlayers){
                     ...
                     if(index === player.index){
                         ...
                         text(allPlayers.player1.name, players[index-2].x, players[index-2].y);
                         text(allPlayers.player2.name, players[index-1].x, players[index-1].y);
                         
                         //text(allPlayers[prl].name, x-10, y+20);
